...
export class Demo implements Experience {
  ...
  init() {
    ...
    this.engine.camera.instance.position.x =  maxX // increased from 2.3205239889866345
    this.engine.camera.instance.position.y = maxY// increased from 2.503533383801548
    ...
    data.electron.map((elec: any) => {
      const electron = new Electron(this.engine.camera, elec.orbits, this.engine.scene)
